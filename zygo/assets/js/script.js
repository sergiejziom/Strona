...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.gg/w6kHZyTa9Q';
      break;
    case 'youtube':
      url = 'https://www.youtube.com/@Zygo0001';
      break;
    case 'twitter':
      url = 'https://steamcommunity.com/profiles/76561199225444119/';
      break;
      case 'twitch':
        url = 'https://www.twitch.tv/zygo_only';
        break;
  }
...
function typerStartTyping(typer) {
  ...
  let text = ['Najlepsze Citizeny Tylko na Fivem Hub Zapraszam'];
